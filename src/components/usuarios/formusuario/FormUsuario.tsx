  ...
  return (
    <>
      <div className="grid grid-cols-1 lg:grid-cols-2 h-screen place-items-center font-bold">
        ...
        <form className='flex justify-center items-center flex-col w-2/3 gap-3' onSubmit={atualizarUsuario}>
          ...
          <div className="flex flex-col w-full">
           ...
           <div className="flex flex-col w-full">
            ...
            >
                <option value={usuario.convenio?.nome} selected disabled>Selecione um Convenio</option>
